  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-950 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-900 rounded-2xl shadow-md p-6 md:p-10">
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{intro}</p>
