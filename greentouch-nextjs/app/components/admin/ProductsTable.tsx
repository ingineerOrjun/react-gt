            ...
            <tr key={p.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
              <td className="px-4 py-3">
                <div className="flex items-center gap-3">
                  <div className="relative h-12 w-12 shrink-0 rounded-lg overflow-hidden bg-slate-100 dark:bg-slate-800 flex items-center justify-center">
                    {p.imageUrl ? (
              ...
              <td className="px-4 py-3 text-slate-600 dark:text-slate-300">{p.display_order}</td>
              <td className="px-4 py-3">
